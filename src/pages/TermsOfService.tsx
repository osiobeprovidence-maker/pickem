    ...
    <div className="min-h-screen overflow-x-clip bg-white">
      <section className="px-5 pb-12 pt-24 sm:px-6 sm:pb-16 sm:pt-32">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-full bg-brand-50 px-4 py-1.5 text-[12px] font-semibold text-brand-700 sm:inline-block">
            Legal
          </div>
      ...
      <section className="px-5 pb-20 sm:px-6 sm:pb-28">
        <div className="mx-auto flex max-w-4xl flex-col gap-5 rounded-[2rem] bg-brand-500 p-8 text-white sm:flex-row sm:items-center sm:justify-between sm:rounded-[2.5rem] sm:p-10">
          <div>
          ...
          <Link
            to="/contact"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-bold text-brand-700 transition-colors hover:bg-brand-50"
          >
            Contact Support
