...
export default function Home() {
  ...
  return (
    <div className="flex w-full flex-col bg-white">
      <section className="overflow-hidden bg-gradient-to-b from-blue-50/60 to-white py-10 md:py-14">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
          <div className="flex max-w-2xl flex-col items-center gap-6 text-center lg:items-start lg:text-left">
            <motion.div
              ...
              className="inline-flex w-fit items-center gap-2 rounded-full border border-blue-100 bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-apple-gray-300 shadow-sm"
            >
            ...
            <motion.h1
              ...
              className="max-w-[9ch] text-5xl font-black leading-[0.98] tracking-tighter text-apple-gray-500 sm:text-6xl lg:text-[4.5rem] xl:text-[5rem]"
            >
              <span className="block">Move anything</span>
              <span className="block text-apple-gray-300">
            ...
            <motion.p
              ...
              className="max-w-xl text-lg font-medium leading-relaxed text-apple-gray-300 lg:text-xl"
            >
            ...
            <motion.div
              ...
              className="flex w-full flex-col justify-center gap-4 sm:w-auto sm:flex-row lg:justify-start"
            >
              <Link
                to="/request"
            ...
            <motion.div
              ...
              className="flex w-full flex-wrap items-stretch justify-center gap-3 text-left lg:justify-start"
            >
              <div className="flex min-w-[220px] flex-1 flex-col gap-1 rounded-2xl border border-apple-gray-100 bg-white px-4 py-3 shadow-sm sm:flex-none">
                <div className="text-[10px] font-black uppercase tracking-[0.18em] text-apple-gray-200">Coverage</div>
                <div className="text-sm font-bold leading-snug text-apple-gray-500">Hostels, classrooms, storefronts</div>
              </div>
              <div className="flex min-w-[220px] flex-1 flex-col gap-1 rounded-2xl border border-apple-gray-100 bg-white px-4 py-3 shadow-sm sm:flex-none">
                <div className="text-[10px] font-black uppercase tracking-[0.18em] text-apple-gray-200">Use Cases</div>
                <div className="text-sm font-bold leading-snug text-apple-gray-500">Deliveries, errands, proxy pickups</div>
              </div>
            </motion.div>
          </div>
